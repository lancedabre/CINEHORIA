  ...
  return (
    <div className="bg-[#050505] text-white min-h-screen scroll-smooth font-sans selection:bg-white selection:text-black">
      ...
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-6 md:px-12 py-6">
        ...
        <Link 
          href="/login" 
          className="border border-white/30 px-6 py-2 text-sm rounded-5xl md:rounded-[3rem] tracking-widest hover:bg-white hover:text-black transition-all duration-300 rounded-sm"
        >
          Try It
        </Link>
      </nav>
      ...
      <main className="pt-24 pb-12 flex flex-col gap-32">
        ...
        <section id="contribute" className="flex flex-col items-center px-4 md:px-12">
          {/* md:flex-row-reverse puts the image on the right on larger screens */}
          <div className="w-full max-w-6xl mt-50 flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-24">
